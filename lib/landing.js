...
export const TESTIMONIALS = [
  {
    quote:
      "Ye Babu Rao ka style hai — bill clear, tension clear!",
    name: "Babu Rao",
  ...
  {
    quote:
      "Ab paisa ka hisaab karne me sirf PayPals meri speed pakad sakta hai!",
    name: "Raju",
  ...
  {
    quote:
      "Ab PayPals ke hote hue Raju mere jute bech ke bach nahi sakta!",
    name: "Shyam",
